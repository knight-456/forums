...
<body>
    ...
    if($method=='POST'){
       ...
       // $th_title = str_replace("<", "&lt;", $th_title);
        ...
        //$sno = $_POST['sno']; 
        $sql = "INSERT INTO `threads` (`threads_title`, `threads_desc`, `threads_cat_id`, `timestamp`) VALUES ( '$th_title', '$th_desc', '$id',current_timestamp())";
        $result = mysqli_query($conn, $sql);
        $showAlert = true;
        if($showAlert){
        ...
        echo '<div class="media my-3">
            ...
            <div class="media-body">'.
             '<h5 class="mt-0"> <a class="text-dark" href="threads.php?threadid=' . $id. '">'. $title . ' </a></h5>
                '. $desc . ' </div>'.'<div class="font-weight-bold my-0"> Asked by: at '. $thread_time. '</div>'.
        '</div>';
